...
import { errorAtom, setErrorAtom } from "@/stores/main.store";
...
export function ErrorAlert() {
	...
	return (
		<motion.div initial={{ x: "10rem", opacity: 0 }} animate={{ x: "0rem", opacity: 1 }} className={`fixed top-4 min-w-[25%] right-4 z-50 max-w-[40%]`}>
